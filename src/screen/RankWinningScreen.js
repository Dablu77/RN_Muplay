...
export default function RankWinningScreen({ navigation }) {
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.Balck }}>
            ...
            <View style={{ height: heightPixel(170), backgroundColor: '#212121', margin: 20, borderRadius: 10 }}>
                <View style={{
                    paddingHorizontal: 15, backgroundColor: "#2a2a2a", paddingVertical: 5,
                    borderTopLeftRadius: 10,
                    borderTopRightRadius: 10
                }}>
                    <Text style={{ color: '#d3d3d3', fontSize: fontPixel(22), fontWeight: '500' }}>#BLRO123</Text>
                </View>
                <Text style={{ color: Colors.Withe, fontSize: fontPixel(25), paddingHorizontal: 20, paddingVertical: 10 }}>10,000</Text>
                <View style={{ alignItems: 'center', }}>
                    <Progress.Bar progress={0.5} width={widthPixel(325)} height={6} color={Colors.Chinesepurple} />
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 22, marginTop: 5 }}>
            ...
            <TouchableOpacity
                style={{ paddingVertical: 10, backgroundColor: Colors.Chinesepurple, alignItems: 'center', justifyContent: 'center', marginHorizontal: 22, marginVertical: 10 }}
            >
                <Text style={{ fontSize: fontPixel(20), fontWeight: '500', color: Colors.Withe, }}>Join 1,000</Text>
            </TouchableOpacity>
            <View style={{ flex: 1, }}>
