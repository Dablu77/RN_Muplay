...
export default function AllScreen({ navigation }) {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.Balck }}>
            <View style={{ height: heightPixel(50), backgroundColor: '#40444a', borderWidth: 1, justifyContent: 'center' }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 15 }}>
                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                        <Text style={{ color: Colors.Withe, fontWeight: '500' }}>Sort By:</Text>
                        <Text style={{ color: Colors.Withe, left: 10, fontWeight: '500' }}>ENRTY</Text>
                        <Image source={require('../../assets/download.png')} style={{ height: heightPixel(15), width: widthPixel(15), left: 12 }} />
                    </View>
                    <Text style={{ color: Colors.Lightgrey, fontSize: fontPixel(17), fontWeight: 'bold', }}>Pool Size</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                        <Text style={{ color: Colors.Lightgrey, fontWeight: 'bold', right: 13 }}>Start Date</Text>
                        <Image source={require('../../assets/filterfilledtoolsymbol.png')} style={{ height: heightPixel(17), width: widthPixel(17), }} />
                    </View>
                </View>
            </View>
                    ...
                    <View
                        ...
                        <View style={{ alignItems: 'center', marginTop: 20 }}>
                            ...
                            <LinearGradient
                                ...
                                style={{ height: heightPixel(7), width: widthPixel(340), backgroundColor: "red", borderRadius: 25 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: "space-between", paddingHorizontal: 15, marginTop: 7 }}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ paddingVertical: 5, backgroundColor: Colors.Chinesepurple, width: widthPixel(65), alignItems: 'center', borderRadius: 4 }}>
                                    <Text style={{ color: Colors.Withe, fontWeight: '500' }}>5,000</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={{
